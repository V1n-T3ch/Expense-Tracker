            ...
            <View style={{backgroundColor: Colors.grey, padding: 20, borderRadius: 20, marginRight: 15, width: 150, gap: 10}}>
                ...
                alignItems: 'center'
                    ...
                    <TouchableOpacity onPress={() => {}}>
                        <Feather name='more-horizontal' size={22} color={Colors.white} />
                    </TouchableOpacity>
                </View>
                <Text style={{color: Colors.white}}>{item.name}</Text>
                <Text style={{color: Colors.white, fontSize: 16, fontWeight: 600}}>Ksh. {amount[0]}.<Text style={{fontSize: 12, fontWeight: 400}}>{amount[1]}</Text></Text>
            </View>
        )
    }
  return (
